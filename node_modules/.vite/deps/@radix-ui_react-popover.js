...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-7BUYPZAJ.js";
import {
  useCallbackRef,
  useEscapeKeydown
} from "./chunk-KACGR4JV.js";
import {
  hideOthers
} from "./chunk-44F4MU6E.js";
import "./chunk-N577ULCA.js";
import {
  Presence
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React8.useState(false);
  ...
  return (0, import_jsx_runtime8.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime8.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React8.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React8.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React8.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React8.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
    const contentRef = React8.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React8.useRef(false);
    React8.useEffect(() => {
      const content = contentRef.current;
      if (content)
        return hideOthers(content);
    }, []);
    return (0, import_jsx_runtime8.jsx)(Combination_default, { as: Slot2, allowPinchZoom: true, children: (0, import_jsx_runtime8.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContentNonModal = React8.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
...
var PopoverContentImpl = React8.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React8.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React8.forwardRef(
  (props, forwardedRef) => {
